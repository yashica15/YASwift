...
//        DDLog.add(DDASLLogger.sharedInstance) // ASL = Apple System Logs
        ...
        config.fileURL = config.fileURL!.deletingLastPathComponent().appendingPathComponent("YASwiftSample.realm")
...
//        }
    ...
    func toastView(hudType:YAHudStyle, strToastMessage:String) -> Void {
